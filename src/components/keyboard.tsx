...
export default function Keyboard({
  ...
  const getColor = (ch: string) => {
    if (greenLetters.includes(ch)) {
      return "bg-[#6ca965] text-white hover:bg-green-700";
    } else if (yellowLetters.includes(ch)) {
      return "bg-[#c8b653] text-white hover:bg-yellow-400";
    } else if (grayLetters.includes(ch)) {
      return "bg-[#787c7f] text-white hover:bg-gray-500 ";
    } else {
      return "bg-gray-200 text-black hover:bg-gray-300 active:bg-gray-300 ";
    }
  };
