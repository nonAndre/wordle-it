...
function Header() {
  ...
  return (
    <>
            ...
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                ...
                <h1 className="font-bold pb-5">
                  Queste sono le tue statistiche
                </h1>
      ...
      <div className="flex flex-row w-full h-1/2 pt-3 items-baseline  justify-between px-5 pb-4">
        <p className="text-bold text-lg text-gray-400 ">casuale</p>
        <p className="text-bold  text-4xl ">WORDLE</p>
        <button
          onClick={(e) => {
            setOpen(true);
